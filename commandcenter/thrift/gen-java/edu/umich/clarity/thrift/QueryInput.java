...
public class QueryInput implements org.apache.thrift.TBase<QueryInput, QueryInput._Fields>, java.io.Serializable, Cloneable, Comparable<QueryInput> {
  ...
  public List<ByteBuffer> input; // required
  ...
  public QueryInput(QueryInput other) {
    ...
    if (other.isSetInput()) {
      List<ByteBuffer> __this__input = new ArrayList<ByteBuffer>(other.input);
  ...
  public java.util.Iterator<ByteBuffer> getInputIterator() {
    return (this.input == null) ? null : this.input.iterator();
  }

  public void addToInput(ByteBuffer elem) {
    if (this.input == null) {
      this.input = new ArrayList<ByteBuffer>();
    }
    this.input.add(elem);
  }

  public List<ByteBuffer> getInput() {
    return this.input;
  }

  public QueryInput setInput(List<ByteBuffer> input) {
    this.input = input;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case INPUT:
      if (value == null) {
        ...
        setInput((List<ByteBuffer>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.input = new ArrayList<ByteBuffer>(_list3.size);
                ByteBuffer _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = iprot.readBinary();
                  struct.input.add(_elem4);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, QueryInput struct) throws org.apache.thrift.TException {
      ...
      if (struct.input != null) {
        oprot.writeFieldBegin(INPUT_FIELD_DESC);
        {
          ...
          for (ByteBuffer _iter7 : struct.input)
          {
      ...
      if (struct.isSetInput()) {
        {
          ...
          for (ByteBuffer _iter9 : struct.input)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.input = new ArrayList<ByteBuffer>(_list13.size);
          ByteBuffer _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = iprot.readBinary();
            struct.input.add(_elem14);
          }
        }
        struct.setInputIsSet(true);
      }
